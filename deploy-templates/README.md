...
**Homepage:** <https://github.com/KubeRocketCI/template-javascript-empty.git>
...
* <https://github.com/KubeRocketCI/template-javascript-empty.git>
...
| image.repository | string | `"frontend-app"` |  |
